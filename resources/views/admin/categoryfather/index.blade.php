                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Vos Parents</h4>
                                            ...
                                            <table class="table align-middle table-nowrap table-check">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="align-middle">Parents</th>
                                                        ...
                                                        <td>
                                                            <div class="d-flex gap-3">
                                                                ...
                                                                <a href="javascript:void(0);" class="text-danger"
                                                                  onclick=" if(confirm('Etes Vous sure de supprimer ce parent ?')){ 
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="orderdetailsModalLabel">Ajouter un parent</h5>
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                  <label for="name">Nom du parent * </label>
                                ...
                                <div class="mb-3">
                                    <label for="manufacturerbrand">Slug du parent * </label>
                                ...
                                <div class="mb-3">
                                    <label for="image">Image du parent</label>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <form action="{{ route('admin.category.updated',$category->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                {{method_field('PUT')}}
                            <div class="modal-body">
