                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="orderdetailsModalLabel">Ajouter un membre</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                             <form action="{{ route('admin.membre.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="manufacturerbrand">Le slug * </label>
                                        <input id="slug" name="slug" type="slug" class="form-control @error('slug') is-invalid @enderror" value="{{ old('slug') }}" required autocomplete="slug">
                                        @error('slug')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                    ...
                    <div class="modal fade orderdetailsModal-{{$admin->id}}" tabindex="-1" role="dialog" aria-labelledby="orderdetailsModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('admin.membre.update',$admin->id) }}" method="post">
                                        {{csrf_field()}}
                                        {{method_field('PUT')}}
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <div class="d-flex text-center">
                                                <div class="form-check form-radio-primary mb-3" style="margin: 0 20px;">
                                                    <input class="form-check-input @error('image') is-invalid @enderror" type="radio" name="radio" required value="{{ old('radio') ?? 1 }}" id="formRadioColor1" @if($admin->status == 1) checked @endif name="radio"  >
                                                    <label class="form-check-label" for="formRadioColor1">
                                                        Admin
                                                    </label>
                                                </div>
                                                ...
                                                <div class="form-check form-radio-primary mb-3" style="margin: 0 20px;">
                                                    <input class="form-check-input @error('image') is-invalid @enderror" type="radio" name="radio" required value="{{ old('radio') ?? 2 }}" id="formRadioColor2" @if($admin->status == 2) checked @endif name="radio"  >
                                                    <label class="form-check-label" for="formRadioColor2">
                                                        Auteur
                                                    </label>
                                                </div>
